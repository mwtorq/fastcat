"""
Extract Fast CAT event results from AKC website for 2023-2024 events.
...
def main(test_mode=False):
    # Input CSV file
    csv_file = r'2023-2024 FastCAT Events.csv'
    
    print("="*80)
    print("Starting Fast CAT results extraction (2023-2024 Events)...")
    print("="*80)
    ...
    if all_results:
        ...
        if test_mode:
            output_file = f"FastCAT_Results_2023_2024_TEST_{timestamp}.xlsx"
        else:
            output_file = f"FastCAT_Results_2023_2024_Complete_{timestamp}.xlsx"
