"""
Import 2021-2022 FastCAT Results from Excel into SQL Server database.
...
# Configuration
EXCEL_FILE = r'Results\2021-2022 FastCAT Results.xlsx'
...
def main():
    """Main function"""
    print("=" * 60)
    print("FastCAT 2021-2022 Results Import Script")
    print("=" * 60)
