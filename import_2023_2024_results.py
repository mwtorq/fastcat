"""
Import 2023-2024 FastCAT Results from Excel into SQL Server database.
...
# Configuration
EXCEL_FILE = r'Results\2023-2024 FastCAT Results.xlsx'
...
def main():
    """Main function"""
    print("=" * 60)
    print("FastCAT 2023-2024 Results Import Script")
    print("=" * 60)
